...
SCHEMA = (
    ...
    "pair06-v8-baseline-game-attempt-invocation-no-offload.v1"
)
CONTRACT_SCHEMA = (
    "void.abaddon.generation2."
    "pair06-v8-baseline-game-attempt-invocation-no-offload-contract.v1"
)
...
SELF_PATH = (
    "openra_env/learning/"
    "abaddon_policy_campaign_runtime_pair06_v8_baseline_attempt_invocation_no_offload_generation2.py"
)
V8_PYTHON = Path(
    "/home/zoso/Downloads/"
    "void-apollyon-v3-qwen35-4b-lora-v1/venv/bin/python3.12"
)
CONFIRM_TOKEN = "VOID_PAIR06_V8_BASELINE_NO_OFFLOAD_GAME_EXECUTE_ONCE"
...
NEXT_GATE = "PAIR06_V8_BASELINE_ATTEMPT_INVOCATION_NO_OFFLOAD_SOURCE_BINDING_REVIEW_REQUIRED"
NEXT_CHANGE_CLASS = "source_only_pair06_v8_baseline_attempt_invocation_no_offload_review"


class Pair06V8BaselineAttemptInvocationNoOffloadHold(RuntimeError):
    pass


def _require(condition: bool, message: str) -> None:
    if not condition:
        raise Pair06V8BaselineAttemptInvocationNoOffloadHold(message)
...
def _not_revoked() -> None:
    if (CLAIMS_ROOT / REVOCATION_NAME).exists():
        raise Pair06V8BaselineAttemptInvocationNoOffloadHold(
...
def execute_pair06_v8_baseline_game_no_offload(
    *,
...
def pair06_v8_baseline_attempt_invocation_no_offload_contract() -> dict[str, Any]:
    dependencies = _dependency_contracts()
    return {
        "schema": CONTRACT_SCHEMA,
        "pair06_v8_baseline_attempt_invocation_no_offload_implemented": True,
        "pair06_v8_baseline_attempt_invocation_no_offload_reviewed": False,
...
def authorize_or_execute(*args: Any, **kwargs: Any) -> None:
    raise Pair06V8BaselineAttemptInvocationNoOffloadHold(NEXT_GATE)
