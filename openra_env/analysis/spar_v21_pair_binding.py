...
from .spar_v21_pair_comparison import (
    PairContractError,
    compare_reports,
    stable_json,
)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Bind semantically identical warm starts before V2.1 pair comparison"
    )
    ...
    try:
        ...
        print(f"V2.1 pair binding error: {error}", file=sys.stderr)
        return 2
