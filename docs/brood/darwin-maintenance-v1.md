...
7. rejects aliases of forbidden builtin capabilities before the aliased call can hide their authority. and
8. rejects bare local-package imports whose reachable submodules cannot be deterministically enumerated.
