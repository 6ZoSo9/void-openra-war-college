"""Inference-safe no-offload V8 parent launcher/supervisor for pair-06.
...
CONTRACT_SCHEMA = (
    ...
    "pair06-v8-parent-launcher-supervisor-no-offload-contract.v1"
)
RECEIPT_SCHEMA = (
    "void.abaddon.generation2."
...
NEXT_GATE = "PAIR06_V8_PARENT_LAUNCHER_SUPERVISOR_NO_OFFLOAD_SOURCE_BINDING_REVIEW_REQUIRED"
NEXT_CHANGE_CLASS = "source_only_pair06_v8_parent_launcher_supervisor_no_offload_review"
...
def execute_pair06_v8_parent_supervisor_no_offload(
    *,
    attempt_id: str,
...
def pair06_v8_parent_launcher_supervisor_no_offload_contract() -> dict[str, Any]:
    dependencies = _dependencies()
    return {
