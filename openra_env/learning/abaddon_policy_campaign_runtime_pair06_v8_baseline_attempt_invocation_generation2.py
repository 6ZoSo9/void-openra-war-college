...
3. create the durable single-use attempt marker;
4. invoke the reviewed V8 parent supervisor with marker SHA-256 as attempt id;
5. create a durable execution-result file immediately after successful game
   completion;
6. clean only the worktrees owned by this invocation;
7. create a durable cleanup-closeout file.
...
SCHEMA = (
    ...
    "pair06-v8-baseline-game-attempt-invocation.v1"
)
CONTRACT_SCHEMA = (
    "void.abaddon.generation2."
    "pair06-v8-baseline-game-attempt-invocation-contract.v1"
)
...
SELF_PATH = (
    "openra_env/learning/"
    "abaddon_policy_campaign_runtime_pair06_v8_baseline_attempt_invocation_generation2.py"
)
V8_PYTHON = Path(
    "/home/zoso/Downloads/"
    "void-apollyon-v3-qwen35-4b-lora-v1/venv/bin/python3.12"
)
CONFIRM_TOKEN = "VOID_PAIR06_V8_BASELINE_GAME_EXECUTE_ONCE"

SUPERVISOR_REVIEW_GIT_BLOB = "98abd7dfabe02bae2533e5578ed29fb84c1083e0"
SUPERVISOR_REVIEW_SOURCE_SHA256 = (
    "ff9db5202c28778c56766cba51b15333b3bf9295d0769ebfc35c25ef68a61fce"
)
...
NEXT_GATE = "PAIR06_V8_BASELINE_ATTEMPT_INVOCATION_SOURCE_BINDING_REVIEW_REQUIRED"
NEXT_CHANGE_CLASS = "source_only_pair06_v8_baseline_attempt_invocation_review"


class Pair06V8BaselineAttemptInvocationHold(RuntimeError):
    pass


def _require(condition: bool, message: str) -> None:
    if not condition:
        raise Pair06V8BaselineAttemptInvocationHold(message)
...
def _dependency_contracts() -> dict[str, Any]:
    sup = supervisor_review.pair06_v8_parent_launcher_supervisor_review_contract()
    ...
    _require(
        sup.get("pair06_v8_parent_launcher_supervisor_reviewed") is True,
...
def execute_pair06_v8_baseline_game(
    *,
    ...
    receipt = supervisor.execute_pair06_v8_parent_supervisor(
    ...
    result_payload = {
        "schema": (
            "void.abaddon.generation2."
            "pair06-v8-baseline-game-result.v1"
        ),
        "pair_slot": PAIR_SLOT,
        "arm": ARM,
        "held_out": HELD_OUT,
    ...
    closeout_payload = {
        "schema": (
            "void.abaddon.generation2."
            "pair06-v8-baseline-game-closeout.v1"
        ),
        "pair_slot": PAIR_SLOT,
        "arm": ARM,
        "attempt_id": attempt_id,
...
def pair06_v8_baseline_attempt_invocation_contract() -> dict[str, Any]:
    dependencies = _dependency_contracts()
    return {
        "schema": CONTRACT_SCHEMA,
        "pair06_v8_baseline_attempt_invocation_implemented": True,
        "pair06_v8_baseline_attempt_invocation_reviewed": False,
        "pair_slot": PAIR_SLOT,
        "arm": ARM,
        "held_out": HELD_OUT,
...
def authorize_or_execute(*args: Any, **kwargs: Any) -> None:
    raise Pair06V8BaselineAttemptInvocationHold(NEXT_GATE)
