...
SCHEMA = (
    ...
    "pair06-v8-baseline-game-attempt-invocation-receipt-bound-no-offload.v1"
)
CONTRACT_SCHEMA = (
    "void.abaddon.generation2."
    "pair06-v8-baseline-game-attempt-invocation-receipt-bound-no-offload-contract.v1"
)
...
SELF_PATH = (
    "openra_env/learning/"
    "abaddon_policy_campaign_runtime_pair06_v8_baseline_attempt_invocation_receipt_bound_no_offload_generation2.py"
)
V8_PYTHON = Path(
    "/home/zoso/Downloads/"
...
NEXT_GATE = "PAIR06_V8_BASELINE_ATTEMPT_INVOCATION_RECEIPT_BOUND_NO_OFFLOAD_SOURCE_BINDING_REVIEW_REQUIRED"
NEXT_CHANGE_CLASS = "source_only_pair06_v8_baseline_attempt_invocation_receipt_bound_no_offload_review"
