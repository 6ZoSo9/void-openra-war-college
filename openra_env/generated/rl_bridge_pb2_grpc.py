...
class RLBridgeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FastAdvance = channel.unary_unary(
                ...
                response_deserializer=rl__bridge__pb2.GameObservation.FromString,
                _registered_method=True)
        self.JointAdvance = channel.unary_unary(
                '/openra.rl.RLBridge/JointAdvance',
                request_serializer=rl__bridge__pb2.JointAdvanceRequest.SerializeToString,
                response_deserializer=rl__bridge__pb2.JointAdvanceResponse.FromString,
                _registered_method=True)
...
class RLBridgeServicer(object):
    ...
    def JointAdvance(self, request, context):
        """Atomic duel step: both external players commit actions at one frozen tick,
        then the shared world advances once and returns both perspectives.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RLBridgeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'JointAdvance': grpc.unary_unary_rpc_method_handler(
                    servicer.JointAdvance,
                    request_deserializer=rl__bridge__pb2.JointAdvanceRequest.FromString,
                    response_serializer=rl__bridge__pb2.JointAdvanceResponse.SerializeToString,
            ),
...
class RLBridge(object):
    ...
    def JointAdvance(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/openra.rl.RLBridge/JointAdvance',
            rl__bridge__pb2.JointAdvanceRequest.SerializeToString,
            rl__bridge__pb2.JointAdvanceResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
